      ...
      <div className="max-w-[1536px] mx-auto">
        ...
        <div className="parent bg-white rounded-[40px] w-[1202px] h-[738px] flex justify-between mx-[119px] pl-[111px]">
          ...
          <div className="left_side">
            ...
            <p className="w-[397px] pt-[15px]">Have some big idea or brand to develop and need help? Then reach out. We'd love to hear about your project and provide help.</p>
